...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableHoras = QtWidgets.QTableWidget(self.centralwidget)
        self.tableHoras.setObjectName("tableHoras")
        self.tableHoras.setColumnCount(7)
        self.tableHoras.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableHoras.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableHoras.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableHoras.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableHoras.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableHoras.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableHoras.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableHoras.setHorizontalHeaderItem(6, item)
        self.tableHoras.horizontalHeader().setCascadingSectionResizes(False)
        self.tableHoras.horizontalHeader().setDefaultSectionSize(150)
        self.tableHoras.verticalHeader().setCascadingSectionResizes(True)
        self.tableHoras.verticalHeader().setMinimumSectionSize(23)
        self.tableHoras.verticalHeader().setSortIndicatorShown(True)
        self.tableHoras.verticalHeader().setStretchLastSection(True)
        self.verticalLayout.addWidget(self.tableHoras)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tableHoras.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Horas"))
        item = self.tableHoras.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Lunes"))
        item = self.tableHoras.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Martes"))
        item = self.tableHoras.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Miercoles"))
        item = self.tableHoras.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Jueves"))
        item = self.tableHoras.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Viernes"))
        item = self.tableHoras.horizontalHeaderItem(6)
